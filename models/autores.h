//deve conter uma lista hashing, com uma lista duplamente encadeada de autor
//atributos:
//int - matricula sera usado para determinar a posiçao dele na fila (nao no hashing)
//string - nome 

//possiveis atributo (matricula, nome)
template <typename T> void pesquisaLista(string atributo, T valor){

}

// lista todos os autores mostrando todos os atributos
void listar(){
